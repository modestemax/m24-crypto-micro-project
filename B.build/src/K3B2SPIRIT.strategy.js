    ...
    async canBuy({ symbolId, timeframe }, last, prev, signal) {
        ...
        if (last && prev && current && currentM5) {
            ...
            if (current.bbu20 > last.bbu20)
                if (last.ema20 > prev.bbu20)
                    if (current.bbl20 < last.bbl20)
                        if (last.bbl20 > prev.bbl20)
                            if (current.ema10 >= current.ema50)
                                if (current.ema10 >= current.ema20)
                                    if (current.ema20 > current.bbb20)
                                        if (current.ema20 >= current.ema30)
                                            if (current.ema30 >= current.bbb20)
                                                if (current.macd > current.macd_signal)
                                                    if (current.macd >= 0)
                                                        if (currentM5.plus_di > 20)
                                                            if (currentM5.minus_di < 20)
                                                                if (currentM5.adx < 20)
